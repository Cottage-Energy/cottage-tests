...
test.describe('EVERSOURCE Utility Session', () => {
  ...
  test('EVERSOURCE Electric Account', async ({moveInpage, page, context}) => {
    ...
    await AdminApi.EVERSOURCE_Sign_Up(AdminApiContext,ElectricAccountId);
    ...
    await AdminApi.EVERSOURCE_Start_Service(AdminApiContext,ElectricAccountId);
    await page.waitForTimeout(5000);
  ...
  //Electric Ever and Diff Gas
  //Diff Electric and Ever Gas
