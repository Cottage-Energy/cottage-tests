...
test.describe('Valid Card Manual Payment', () => {
  ...
  test('BGE Electric Only Valid Card Payment Move In Added', async ({moveInpage, page, sidebarChat, billingPage, context}) => {
      ...
      MoveIn = await MoveInTestUtilities.BGE_New_User_Move_In_Manual_Payment_Added(moveInpage, true, true);
      ...
      await Promise.all([
          ...
          //billingPage make Payment button visible
  ...
  test('xx CON-EDISON COMED Electric Only Valid Bank Payment Move In Added', async ({moveInpage, page, sidebarChat, billingPage, context}) => {
      //MAKE IT COMED BLDG. with ELECTRIC ONLY
      test.setTimeout(1800000);
  ...
  test('xx NGMA Electric Only Valid Auto Payment Finish Account Added', async ({moveInpage, finishAccountSetupPage, page, sidebarChat, billingPage, context}) => {
  ...
  test('xx BGE Electric & Gas Valid Auto Payment Move In Added', async ({moveInpage, finishAccountSetupPage, page, sidebarChat, billingPage, context}) => {
  ...
  test('xx EVERSOURCE COMED Electric & Gas Valid Auto Payment Move In Added', async ({moveInpage, finishAccountSetupPage, page, sidebarChat, billingPage, context}) => {
  ...
  test('xx CON-EDISON  Gas Only Valid Auto Payment Move In Added', async ({moveInpage, finishAccountSetupPage, page, sidebarChat, billingPage, context}) => {
  ...
  test('xx EVERSOURCE CON-EDISON Gas Only Valid Auto Payment Finish Account Added', async ({moveInpage, finishAccountSetupPage, page, sidebarChat, billingPage, context}) => {
  ...
  test('xx BGE Gas Only Valid Auto Payment Finish Account Added', async ({moveInpage, finishAccountSetupPage, page, sidebarChat, billingPage, context}) => {
