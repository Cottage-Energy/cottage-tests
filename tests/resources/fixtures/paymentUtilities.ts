...
export class PaymentUtilities {
    ...
    async Auto_Payment_Failed_Card_Pay_Bill_Link_Update_Electric_Bill(page:any, overviewPage:any, billingPage:any, sidebarChat:any, MoveIn: any, profilePage: any, PGuserUsage: any, ElectricAccountId: string){
        //AUTO PAYMENT CHECKS
        await Promise.all([
            supabaseQueries.Check_Electric_Bill_Visibility(ElectricAccountId, false),
            supabaseQueries.Check_Eletric_Bill_Reminder(ElectricAccountId, true),
    ...
    async Auto_Payment_Failed_Card_Pay_Bill_Link_Update_Electric_Gas_Bill(page:any, overviewPage:any, billingPage:any, sidebarChat:any, MoveIn: any, profilePage: any, PGuserUsage: any, ElectricAccountId: string, GasAccountId: string){
        //AUTO PAYMENT CHECKS
        await supabaseQueries.Check_Electric_Bill_Visibility(ElectricAccountId, false);
        await supabaseQueries.Check_Eletric_Bill_Reminder(ElectricAccountId, true);
        await supabaseQueries.Check_Gas_Bill_Visibility(GasAccountId, false);
    ...
    async Auto_Payment_Failed_Card_Pay_Bill_Link_Update_Gas_Bill(page:any, overviewPage:any, billingPage:any, sidebarChat:any, MoveIn: any, profilePage: any, PGuserUsage: any, GasAccountId: string){
        //AUTO PAYMENT CHECKS
        await Promise.all([
            supabaseQueries.Check_Gas_Bill_Visibility(GasAccountId, false),
            supabaseQueries.Check_Gas_Bill_Reminder(GasAccountId, true),
