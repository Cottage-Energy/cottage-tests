...
import { type GetEvents, type Inngest, type builtInMiddleware } from "./components/Inngest";
...
import { type AsTuple, type IsEqual, type IsNever, type IsStringLiteral, type ObjectPaths, type Simplify, type WithoutInternal } from "./helpers/types";
import { type Logger } from "./middleware/logger";
export declare const failureEventErrorSchema: z.ZodEffects<z.ZodCatch<z.ZodObject<{
 ...
 * @public
 */
export type InvokeTargetFunctionDefinition = InngestFunctionReference.Any | InngestFunction.Any | string;
/**
