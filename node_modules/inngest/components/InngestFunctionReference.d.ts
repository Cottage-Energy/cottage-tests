...
import { type ResolveSchema } from "../helpers/validators";
 ...
 * @public
 */
export declare const referenceFunction: <TArgs extends InngestFunctionReference.HelperGenericArgs<TFnInput, TFnOutput>, TFnInput extends import("../helpers/validators").ValidSchemaInput = import("../helpers/validators").ValidSchemaInput, TFnOutput extends import("../helpers/validators").ValidSchemaOutput = import("../helpers/validators").ValidSchemaOutput>({ functionId, appId, }: TArgs extends InngestFunction.Any ? Omit<InngestFunctionReference.HelperArgs<any, any>, "schemas"> : TArgs) => InngestFunctionReference.HelperReturn<TArgs>;
/**
 * A reference to an `InngestFunction` that can be used to represent both local
 * and remote functions without pulling in the full function definition (i.e.
 * dependencies).
