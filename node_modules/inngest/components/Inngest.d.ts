...
export declare class Inngest<TClientOpts extends ClientOptions = ClientOptions> {
     ...
     * ```
     */
    constructor({ id, eventKey, baseUrl, fetch, env, logger, middleware, isDev, }: TClientOpts);
    /**
...
export declare const builtInMiddleware: [InngestMiddleware<{
    ...
    init({ client }: {
        ...
        onFunctionRun(arg: Readonly<{
            ...
            ctx: Pick<Record<string, unknown> & Readonly<import("../types").BaseContext<Inngest.Any, string>>, "event" | "runId">;
        }>): {
            transformInput(): {
                ctx: {
                    /**
...
export declare namespace Inngest {
    ...
    type CreateFunction<TClient extends Inngest.Any> = <TFnOpts extends Omit<InngestFunction.Options<TClient, TMiddleware, AsArray<TTrigger>, TFailureHandler>, "triggers">, TMiddleware extends InngestMiddleware.Stack, TTrigger extends SingleOrArray<InngestFunction.Trigger<TriggersFromClient<TClient>>>, THandler extends Handler.Any = Handler<TClient, EventNameFromTrigger<GetEvents<TClient, true>, AsArray<TTrigger>[number]>, ExtendWithMiddleware<[
        ...
        NonNullable<ClientOptionsFromInngest<TClient>["middleware"]>,
        TMiddleware
    ], FailureEventArgs<GetEvents<TClient, true>[EventNameFromTrigger<GetEvents<TClient, true>, AsArray<TTrigger>[number]>]>>>>(options: TFnOpts, trigger: TTrigger, handler: THandler) => InngestFunction<InngestFunction.Options<TClient, TMiddleware, AsArray<TTrigger>, TFailureHandler>, THandler, TFailureHandler, TClient, TMiddleware, AsArray<TTrigger>>;
}
/**
