        ...
        const stepHandler = async ({ args, matchOp, opts, }) => {
            ...
            if (!beforeExecHooksPromise && this.state.allStateUsed()) {
                await (beforeExecHooksPromise = (async () => {
                    var _a, _b, _c, _d;
                    await ((_b = (_a = this.state.hooks) === null || _a === void 0 ? void 0 : _a.beforeExecution) === null || _b === void 0 ? void 0 : _b.call(_a));
                    await ((_d = (_c = this.state.hooks) === null || _c === void 0 ? void 0 : _c.afterMemoization) === null || _d === void 0 ? void 0 : _d.call(_c));
                })());
            }
            return promise;
        };
