...
import { type ExclusiveKeys, type ObjectPaths, type ParametersExceptFirst, type SendEventPayload, type SimplifyDeep } from "../helpers/types";
 ...
 */
export declare const createStepTools: <TClient extends Inngest.Any, TTriggers extends TriggersFromClient<TClient> = TriggersFromClient<TClient>>(client: TClient, execution: InngestExecution, stepHandler: StepHandler) => {
    /**
     ...
     */
    sendEvent: <Payload extends SendEventPayload<import("../helpers/types").WithoutInternal<import("./Inngest").EventsFromOpts<ClientOptionsFromInngest<TClient>>>>>(idOrOptions: StepOptionsOrId, payload: Payload) => Promise<SendEventOutput<ClientOptionsFromInngest<TClient>>>;
    /**
     ...
     */
    waitForEvent: <IncomingEvent extends TriggersFromClient<TClient>>(idOrOptions: StepOptionsOrId, opts: WaitForEventOpts<GetEvents<TClient, true>, TTriggers & string, IncomingEvent>) => Promise<IncomingEvent extends TriggersFromClient<TClient> ? GetEvents<TClient, true>[IncomingEvent] | null : IncomingEvent | null>;
    /**
     ...
     * for next steps.
     */
    run: <T extends () => unknown>(idOrOptions: StepOptionsOrId, fn: T) => Promise<SimplifyDeep<Jsonify<T extends () => Promise<infer U> ? Awaited<U extends void ? null : U> : ReturnType<T> extends void ? null : ReturnType<T>>>>;
    /**
...
type InvocationOpts<TFunction extends InvokeTargetFunctionDefinition> = InvocationTargetOpts<TFunction> & TriggerEventFromFunction<TFunction> & {
    /**
