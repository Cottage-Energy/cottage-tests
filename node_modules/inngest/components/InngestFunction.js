...
class InngestFunction {
    ...
    baseUrl, appPrefix) {
        ...
        const _c = this.opts, { retries: attempts, cancelOn } = _c, opts = __rest(_c, ["retries", "cancelOn"]);
        /**
         * Convert retries into the format required when defining function
         * configuration.
         */
        const retries = typeof attempts === "undefined" ? undefined : { attempts };
        const fn = Object.assign(Object.assign({}, opts), { id: fnId, name: this.name, triggers: ((_a = this.opts.triggers) !== null && _a !== void 0 ? _a : []).map((trigger) => {
                if ("event" in trigger) {
                    return {
                        event: trigger.event,
