...
import { type Cancellation, type ConcurrencyOption, type EventNameFromTrigger, type Handler, type TimeStr, type TimeStrBatch, type TriggersFromClient } from "../types";
import { type GetEvents, type Inngest } from "./Inngest";
import { type InngestMiddleware } from "./InngestMiddleware";
import { ExecutionVersion, type InngestExecutionOptions } from "./execution/InngestExecution";
/**
...
export declare namespace InngestFunction {
    ...
    interface Options<TClient extends Inngest.Any = Inngest.Any, TMiddleware extends InngestMiddleware.Stack = InngestMiddleware.Stack, TTriggers extends InngestFunction.Trigger<TriggersFromClient<TClient>>[] = InngestFunction.Trigger<TriggersFromClient<TClient>>[], TFailureHandler extends Handler.Any = Handler.Any> {
        ...
        cancelOn?: Cancellation<GetEvents<TClient, true>, EventNameFromTrigger<GetEvents<TClient, true>, TTriggers[number]> & string>[];
        /**
